...
echo "************************************"
consul agent -ui -server -bootstrap-expect=1 -client=0.0.0.0 -data-dir=\tmp\consul -node=agent-one -bind=192.168.100.1 -enable-script-checks=true -config-dir=/etc/consul.d
...
sed -i 's/const HOST='192.168.100.3';/const HOST='192.168.100.1';/g' /home/vagrant/consulService/app/index.js